const icons = {
  ...
  handshake: (
    <>
      <path d="m8 12 2 2 3-3 3 3 4-4" />
      <path d="M3 9h4l3-3h4l3 3h4" />
      <path d="M5 15h3M16 15h3" />
    </>
  ),
  factory: (
    <>
      <path d="M3 21h18M5 21V9l5 3V9l5 3h4v9" />
      <path d="M17 12V5h3v7" />
    </>
  ),
  building: (
  ...
  brush: <path d="M18.4 4.6a2.1 2.1 0 0 1 3 3L12 17l-4 1 1-4 9.4-9.4ZM6 20c-2 0-3-1-3-3 0-1.5 1.5-2.5 3-2" />,
  sprout: (
    <>
      <path d="M12 21V11" />
      <path d="M12 11C8 11 5 8 5 4c4 0 7 3 7 7ZM12 14c4 0 7-3 7-7-4 0-7 3-7 7Z" />
    </>
  ),
  file: (
    <>
